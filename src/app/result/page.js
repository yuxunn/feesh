      ...
      <div className="text-black text-center text-sm">
        <div className="share mt-2 text-center">
          ...
          <div className="pb-2">
            ...
            <button
              onClick={() => router.push("/")}
              className="bg-[#FFB8B8] text-black w-[12em] h-[3em] text-l py-2 px-4 border-2 border-black rounded-lg hover:bg-[#DF9A9A] transition duration-300 mt-2 mb-6"
            >
              Restart
            </button>
          </div>
        </div>
        <div className="text-black p-2 text-center text-sm">
          <p>Made by @jing.yunn and @yuxun3696 :)</p>
          <a
            href="https://github.com/yuxunn/feesh"
            className="flex justify-center items-center space-x-2"
          >
            <img
              src="/static/socials/github.png"
              alt="GitHub"
              className="w-6 h-6"
            />
            <span>GitHub</span>
